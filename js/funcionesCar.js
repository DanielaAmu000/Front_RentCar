...
function postCar(){
    ...
    console.log(cajas);
    $.ajax({
        url:"http://192.18.129.4:8080/api/Car/save",
        type:"POST",
        datatype:"JSON",
...
$.ajax({
    url:"http://192.18.129.4:8080/api/Car/update",
    type:"PUT",
    datatype:"JSON",
...
function deleteCar(idBoton){
    Swal.fire({
        title: 'Estás seguro de borrar el carro?',
        ...
        if (result.isConfirmed) {
          Swal.fire(
            'Borrado',
            'El carro se ha borrado correctamente.',
            'exitoso'
        ...
        $.ajax({
            url:"http://192.18.129.4:8080/api/Car/"+idBoton,
            type:"DELETE",
            datatype:"JSON",
...
function getGamaRelacion(){
    $.ajax({
        url:"http://192.18.129.4:8080/api/Gama/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){

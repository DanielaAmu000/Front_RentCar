...
function postGama(){
    ...
    $.ajax({
        url:"http://192.18.129.4:8080/api/Gama/save",
        type:"POST",
        datatype:"JSON",
...
function putGama(idBotonActualizar){
    ...
    $.ajax({
        url:"http://192.18.129.4:8080/api/Gama/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteGama(idBoton){
    ...
    Swal.fire({
        title: 'Esta seguro de borrar la gama?',
        ...
        if (result.isConfirmed) {
          Swal.fire(
            'Borrado!',
            'La gama se ha borrado correctamente.',
            'exitoso'
        ...
        $.ajax({
            url:"http://192.18.129.4:8080/api/Gama/"+idBoton,
            type:"DELETE",
            datatype:"JSON",
